<template>
  <section>
    <article v-for="(item, index) in items" :key="index">
      ...
      <button class="see-more" @click="() => seeMore(item)">
        <svg width="20px" height="20px" viewBox="0 -28.56 147.25 147.25" xmlns="http://www.w3.org/2000/svg">
...
export type BlogPostTag = 'Best practices' | 'CSS' | 'JS' | 'TS'
